...
| :--- | :--- | :--- | :--- |
| **Moons** | r-PCF | 1.0000 | 0.02 |
| | **VNS-RPCF** | **1.0000** | 0.69 |
| **Breast Cancer** | r-PCF | 0.9474 | 0.10 |
| | **VNS-RPCF** | 0.8947 | 4.35 |
| **Blobs 3D** | r-PCF | 1.0000 | 0.01 |
| | **VNS-RPCF** | **1.0000** | 0.44 |
| **WBCD** (Diagnosis) | r-PCF | 0.9415 | 0.08 |
| | **VNS-RPCF** | **0.9415** | 3.61 |
| **WBCP** (Prognostic)| r-PCF | 0.7667 | 0.03 |
| | **VNS-RPCF** | **0.7833** | 0.91 |
| **Heart** | r-PCF | 0.7363 | 0.15 |
| | **VNS-RPCF** | **0.7912** | 7.15 |
| **Votes** | r-PCF | 0.9160 | 0.06 |
| | **VNS-RPCF** | **0.9389** | 3.49 |
| **Ionosphere** | r-PCF | 0.8868 | 0.07 |
| | **VNS-RPCF** | 0.8774 | 2.96 |
| **Liver** | r-PCF | 0.9615 | 0.10 |
| | **VNS-RPCF** | **0.9712** | 1.51 |

### Yorumlar

1.  **Doğruluk Artışı**: `Heart`, `WBCP`, `Votes` ve `Liver` gibi gürültülü veya karmaşık karar sınırlarına sahip veri setlerinde **VNS-RPCF**, standart yönteme göre daha yüksek doğruluk oranlarına ulaşmıştır. Özellikle `Heart` veri setinde yaklaşık **%6**'lık bir başarı artışı gözlemlenmiştir. Bu durum, VNS'in yerel arama stratejisinin daha "derin" ve kapsayıcı konik fonksiyonlar bulduğunu doğrular.
